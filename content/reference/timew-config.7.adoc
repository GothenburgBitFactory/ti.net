...
*color*::
Determines whether output is colored.
+
May be overridden by the ':color' or ':nocolor' hint.
+
By default, Timewarrior disables color output when its output is not a terminal.
