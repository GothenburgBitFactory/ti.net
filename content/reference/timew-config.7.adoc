...
== SYNOPSIS
**timew rc.**_<name>_**=**_<value>_ _<command>_
...
Default values may be overridden by timewarrior.cfg values, which may in turn be overridden on the command line using: **rc.**_<name>_**=**_<value>_
