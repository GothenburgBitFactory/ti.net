...
== HINTS
Apart from range hints (see link:../../reference/timew-hints.7/[*timew-hints*(7)]), the chart reports adhere to the following hints:
...
The value has to be a range hint (without the prefix colon), see link:../../reference/timew-hints.7/[*timew-hints*(7)].
...
See link:../../reference/timew-ranges.7/[*timew-ranges*(7)] and link:../../reference/timew-hints.7/[*timew-hints*(7)] on the different ways to provide date ranges.
