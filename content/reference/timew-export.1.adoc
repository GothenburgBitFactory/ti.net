...
Supply either a list of interval IDs, or a range and/or tag filter (see link:../../reference/timew-ranges.7/[*timew-ranges*(7)] and link:../../reference/timew-tags.1/[*timew-tags*(1)]) to export only a subset of intervals.
